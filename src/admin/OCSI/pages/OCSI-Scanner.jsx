...
const OCSIHybridQRScanner = () => {
    ...
    try {
      ...
      if (navigator.onLine) {
        ...
        const res = await fetch(
          `${API_BASE_URL}/api/OCSI/asset/get/${encodeURIComponent(serialNumber)}?category=${categoryParam}`,
          {
            headers: {
  ...
  const handleScan = (raw) => {
    ...
    if (!category) {
      ...
      navigate(
        `/ocsi/assets/rentals/details/${encodeURIComponent(serialNumber)}`,
      );
    } else {
...
export default OCSIHybridQRScanner;
