        ...
        <main className="p-6 space-y-6">
          ...
          <section className="mb-10 grid grid-cols-12 gap-6 items-end">
            <div className="col-span-12 md:col-span-8 flex flex-wrap gap-8 items-end bg-surface-container-lowest p-2 rounded-xl editorial-shadow">
              <div className="flex flex-wrap gap-4 items-end dark:bg-slate-800 p-4 rounded-xl dark:border-slate-700">
                <div>
                ...
                <label className="text-sm gap-2 flex items-center font-semibold text-slate-700">
                  <input
                    ...
                    className="rounded text-rose-500 focus:ring-rose-500/20 w-5 h-5 border-slate-300"
                  />
                ...
                <button
                  ...
                  className="ml-auto bg-emerald-600 text-white px-4 py-2 rounded-lg hover:bg-emerald-700 transition"
                >
                  Export to Excel
                </button>
              </div>
